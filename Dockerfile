...
#   - Ex: docker.io/hexpm/elixir:1.19.5-erlang-28.3.1-debian-trixie-20260518-slim
#
...
RUN apt-get update \
  && apt-get install -y --no-install-recommends libstdc++6 openssl curl libncurses6 locales ca-certificates \
  && rm -rf /var/lib/apt/lists/*
